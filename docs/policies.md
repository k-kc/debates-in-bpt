...
Tuesdays 2–3 PM via Zoom and Thursdays 12–1 PM in person (right after class). These are open office hours—no appointment needed. If those times don't work for you, email me and we'll find a time that does. 
...
You will receive feedback on graded seminars through discussion and self-assessment. Written feedback on essays will be provided within two weeks of submission. Rubrics are available on the course page.
